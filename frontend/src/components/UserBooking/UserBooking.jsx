...
//               <h2 className="text-lg font-bold">Package Status</h2>
//               <p className="text-gray-700">{packageStatus}</p>
//             </div>
//           )}
...
//               <div className="pb-3">
//                 <h2 className="text-lg font-bold">Book a Pickup</h2>
...
//               {price && !findingDriver && (
//                 <div className="mt-4">
//                   <p className="text-lg font-bold">Estimated Price: ${price}</p>
//                   <button
...
//                 Current Driver Location: Latitude {driverLocation[0]}, Longitude{" "}
//                 {driverLocation[1]}
//               </p>
//             </div>
//           )}
...
//           {error && (
//             <div className="bg-red-100 shadow-md rounded-lg p-6 sm:col-span-2 lg:col-span-1 xl:col-span-2">
...
//             {/* Package Status Section
//             {packageStatus && (
//               <Card className="bg-blue-100 shadow-md rounded-lg p-6 sm:col-span-2 lg:col-span-1 xl:col-span-2">
//                 <CardHeader>
...
//                   </p>
//                   <p>Latitude : {driverLocation[0]}, Longitude{" "} : {driverLocation[1]}</p>
//                 </CardContent>
//               </Card>
//             )}
...
//             {/* Display any error messages */}
//             {error && (
//               <Card className="bg-red-100 shadow-md rounded-lg p-6 sm:col-span-2 lg:col-span-1 xl:col-span-2">
//                 <CardHeader>
    ...
    <div className="flex min-h-screen w-full bg-gray-100">
      ...
      <aside className="w-64 bg-gray-800 text-white">
        ...
        <nav className="px-4">
          <ul className="space-y-4">
            <li>
              <a href="#" className="flex items-center space-x-2 text-sm hover:bg-gray-700 p-2 rounded">
                <FiHome />
                <span>Dashboard</span>
              </a>
            </li>
      ...
      <div className="flex-1 flex flex-col bg-muted/40">
        ...
        <header className="bg-white shadow-md py-4 px-6">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <span>Welcome, User</span>
              <button className="px-4 py-2 bg-blue-600 text-white rounded">Log out</button>
            </div>
          </div>
        </header>
              ...
              <Card className="bg-white shadow-md rounded-lg p-6 sm:col-span-2 lg:col-span-1 xl:col-span-2">
                ...
                <CardContent>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="pickup-latitude" className="block text-sm font-medium text-gray-700">
                          Pickup Latitude
                        </label>
                        <input
                          id="pickup-latitude"
                      ...
                      <div>
                        <label htmlFor="pickup-longitude" className="block text-sm font-medium text-gray-700">
                          Pickup Longitude
                        </label>
                        <input
                          id="pickup-longitude"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <label htmlFor="dropoff-latitude" className="block text-sm font-medium text-gray-700">
                          Dropoff Latitude
                        </label>
                        <input
                          id="dropoff-latitude"
                      ...
                      <div>
                        <label htmlFor="dropoff-longitude" className="block text-sm font-medium text-gray-700">
                          Dropoff Longitude
                        </label>
                        <input
                          id="dropoff-longitude"
